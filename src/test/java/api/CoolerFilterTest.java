...
public class CoolerFilterTest {
    ...
    public static void post(){
        try {
            // Endpoint URL
            String endpointUrl = "http://localhost:8080/RigBuilder_webapp_project_war_exploded/api/coolers/filters";

            // Creazione del JSON dei parametri di filtro
            Gson gson = new Gson();
            JsonObject filterParams = new JsonObject();
//            filterParams.addProperty("name", "nzxt");
//            filterParams.addProperty("priceSort", "asc");
//            filterParams.addProperty("ratingSort", "desc");
            filterParams.addProperty("minPrice", 0);
            filterParams.addProperty("maxPrice", 215);
            filterParams.addProperty("minCoolerHeight", 0);
            filterParams.addProperty("maxCoolerHeight", 0);
            filterParams.addProperty("radiatorSize", 240);
    ...
    public static void get(){
        try {
            // Endpoint URL
            String endpointUrl = "http://localhost:8080/RigBuilder_webapp_project_war_exploded/api/coolers";
