...
public class ProcessorFilterTest {
    ...
    public static void post(){
        try {
            // Endpoint URL
            String endpointUrl = "http://localhost:8080/RigBuilder_webapp_project_war_exploded/api/processors/filters";
...
//            filterParams.addProperty("maxPrice", 500.0);
    ...
    public static void get(){
        try {
            // Endpoint URL
            String endpointUrl = "http://localhost:8080/RigBuilder_webapp_project_war_exploded/api/processors";
