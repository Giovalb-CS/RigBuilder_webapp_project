...
<html>
    <head>
        ...
        <title>Add Cooler - RigBuilder</title>
    ...
    <body id="top">
        ...
        <form action="addCooler" method="post" class="form-container">
            ...
            <div class="input-container">
                ...
                <input type="number" name="rpm" id="rpm" step="1" required>
            </div>

            <div class="input-container">
                <label for="noiseLevel">Noise Level</label>
                <input type="number" name="noiseLevel" id="noiseLevel" step="1" required>
            </div>
            ...
            <div class="input-container">
                ...
                <input type="number" name="coolerHeight" id="coolerHeight" step="1" required>
            </div>
            ...
            <script src="${pageContext.request.contextPath}/js/coolerToggleSwitch.js"></script>
