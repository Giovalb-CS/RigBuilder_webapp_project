...
<html>
    ...
    <body id="top">
        ...
        <form action="addSsd" method="post" class="form-container">
            ...
            <div class="input-container">
                ...
                <input list="pcie_genList" id="pcie_gen" name="pcie_gen" placeholder="Select or insert generation" required>
            ...
            <div class="input-container">
                ...
                <input list="capacityList" id="capacity" name="capacity" placeholder="Select or insert a new capacity" required>
            ...
            <div class="input-container">
                ...
                <input type="number" name="speed_read" id="speed_read" step="1" required>
            </div>

            <div class="input-container">
                <label for="speed_write">Speed Write</label>
                <input type="number" name="speed_write" id="speed_write" step="1" required>
            </div>
