...
<html>
    <head>
        ...
        <title>Add RAM - RigBuilder</title>
    ...
    <body id="top">
        ...
        <form action="addRam" method="post" class="form-container">
            ...
            <div class="input-container">
                ...
                <input type="number" name="tdp" id="tdp" step="1" placeholder="∽1W x DIMM" required>
            </div>
            ...
            <div class="input-container">
                ...
                <input type="number" name="clock" id="clock" step="1" required>
            </div>
