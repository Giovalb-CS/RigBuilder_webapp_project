...
<html>
    ...
    <body id="top">
        ...
        <form class="add-button-container">
            <button type="submit" formmethod="get" formaction="addRam"><i class="fa fa-plus-square-o" aria-hidden="true"></i>Add <%=fileName.substring(0, fileName.length()-1)%></button>
        </form>

        <%if (rams == null || rams.isEmpty()){%>
        <div class="no-items-container">
            <p>No <%=fileName%> found in the database or no components with selected filter found. Add some.</p>
            <form class="filter-reset-button-container" action="rams" method="get">
        ...
        <div class="filters-container">
            ...
            <div class="main-filters-container">
                ...
                <!-- Campo ID -->
                <form action="rams" method="get" class="filter-item">
                ...
                <!-- Clock min -->
                <form action="rams" method="get" class="filter-item">
                    <label for="clock">Min Clock:</label>
                    <input type="number" id="clock" name="clock" step="1" required>
                    <button type="submit">Filter by min clock</button>
                </form>
            </div>
            ...
            <div class="composite-filter-container">
                ...
                <form action="rams" method="get">
                    ...
                    <!-- Clock tra X e Y -->
                    <label for="compositeMinClock">Min Clock:</label>
                    <input type="number" id="compositeMinClock" name="compositeMinClock" step=1">
                    <label for="compositeMaxClock">Max Clock:</label>
                    <input type="number" id="compositeMaxClock" name="compositeMaxClock" step=1">
        ...
        <div class="list-container">
            <%for (RAM ram : rams){%>
            <div class="component">
                <img src="<%=ram.getImage_URL()%>" alt="<%=ram.getName()%>">

                <div class="component-info-container">
                    <%
                        String componentName = ram.getName();
                    ...
                    <div class="group-container">
                        ...
                        <p class="group-content"><%=ram.getId()%></p>
                    </div>
                    <div class="group-container rating-container">
                        <p class="group-label">Rating</p>
                        <p class="group-content"><i class="fa fa-star" aria-hidden="true"></i><%=ram.getRating()%></p>
                    </div>
                    <div class="group-container">
                        <p class="group-label">Price</p>
                        <p class="group-content">€<%=ram.getPrice()%></p>
                    </div>
                    <div class="group-container">
                        <p class="group-label">Shop URL</p>
                        <a href="<%=ram.getShop_URL()%>"><p class="group-content">Link</p></a>
                    </div>
                    <div class="group-container">
                        <p class="group-label">TDP</p>
                        <p class="group-content">∽<%=ram.getTdp()%>W</p>
                    </div>
                    <div class="group-container">
                        <p class="group-label">Ram Type</p>
                        <p class="group-content"><%=ram.getType()%></p>
                    </div>
                    <div class="group-container">
                        <p class="group-label">Clock Max Speed</p>
                        <p class="group-content"><%=ram.getClock()%>MHz</p>
                    </div>
                </div>

                <form class="component-buttons-container">
                    <input type="hidden" name="id" value="<%=ram.getId()%>">
                    <button type="submit" formmethod="get" formaction="editRam"><i class="fa fa-pencil" aria-hidden="true"></i>Edit</button>
                    <button type="button" class="remove-button" data-id="<%=ram.getId()%>" data-filename="<%=fileName%>"><i class="fa fa-times-circle-o" aria-hidden="true"></i>Remove</button>
                </form>
            </div>
            <%}%>
        </div>
        ...
        <div id="remove-popup" class="popup">
            <div class="popup-content">
                <h2></h2>
                <form id="remove-form" action="removeRam" method="post">
