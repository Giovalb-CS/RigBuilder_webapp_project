...
// Funzione per caricare i form factor esistenti dall'input nascosto
function loadExistingFormFactors(existingFormFactorString) {
    if (existingFormFactorString) {
        const formFactorsArray = existingFormFactorString.split('/'); // Split della stringa dei form factor
        formFactorsArray.forEach(formFactor => {
...
// Aggiungi un form factor alla lista di form factors selezionati al momento della pressione di Invio
...
// Aggiungi un form factor alla lista di form factor selezionati tramite cambio del datalist
...
function updateSelectedFormFactorsDisplay() {
    ...
    console.log(hiddenFormFactorField.value);
}
...
document.addEventListener('DOMContentLoaded', function () {
    // Prendi la stringa dei form factor dall'attributo data-formFactors
...
// Aggiungi evento di keydown a livello di documento per evitare la rimozione dei form factor
